...
const Page = () => {
  ...
  const sendMessage = async () => {
    ...
    const response = await fetch('http://lax.nonev.win:5000/test', {
      method: 'POST',
      headers: {
...
//===================
  ...
  //     <div className="flex flex-col h-screen justify-between items-center bg-gray-100 overflow-hidden">
  //       <div className="w-full max-w-4xl p-5 bg-white shadow-md rounded-lg overflow-auto">
  //         <header className="text-center">
  //           <h1 className="text-3xl text-blue-600">Welcome to E-TA</h1>
  //           <p className="text-xl text-gray-600">Your AI-powered assistant</p>
  //         </header>
  ...
  //           <section className="chatbot">
  //             <div className="bg-white border-2 border-blue-600 rounded-lg p-5">
  //               <div className="overflow-y-auto mb-5 p-2.5 bg-gray-200 border border-gray-300 rounded-lg" style={{ maxHeight: '50vh' }}>
  //                 {messages.map((msg, index) => (
  //                   <p key={index}>{msg}</p>
  //                 ))}
  //               </div>
